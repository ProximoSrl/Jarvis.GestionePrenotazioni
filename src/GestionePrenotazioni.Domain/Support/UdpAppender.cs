    ...
    public class UdpAppender : AppenderSkeleton
    {
        ...
        public static void AppendToConfiguration()
        {
            ...
            foreach (var loggerRepository in repositories)
            {
                ...
                foreach (var l in loggerRepository.GetCurrentLoggers())
                {
                    var logattac = l as IAppenderAttachable;
                    var app = logattac.GetAppender(appender.Name);
                    if (app == null)
                    {
                        logattac.AddAppender(appender);
                    }
                }
        ...
        static void loggerRepository_ConfigurationChanged(object sender, EventArgs e)
        {
